...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, obstacle_type):
        ...
        if obstacle_type == "snail":
            snail1_path = os.path.dirname(__file__) + "/../graphics/snail/snail1.png"
            snail1 = pygame.image.load(snail1_path).convert_alpha()
            snail2_path = os.path.dirname(__file__) + "/../graphics/snail/snail2.png"
        ...
        if obstacle_type == "fly":
            fly1_path = os.path.dirname(__file__) + "/../graphics/Fly/Fly1.png"
            fly1 = pygame.image.load(fly1_path).convert_alpha()
            fly2_path = os.path.dirname(__file__) + "/../graphics/Fly/Fly2.png"
